...
มี custom events สำหรับ funnel หลัก เช่น `upload_selected`, `analyze_clicked`, `analysis_success`, `analysis_error`, `story_create_clicked`, `story_share_clicked`, `story_capture_opened`, และ `pwa_install_clicked`

## PWA

โปรเจกต์รองรับการติดตั้งเป็นเว็บแอปผ่าน browser ที่รองรับ และมีคำแนะนำ Add to Home Screen สำหรับ iPhone Safari
